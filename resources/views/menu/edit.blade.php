...
@section('content')
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <form class="form-horizontal form-material mx-2" action="{{ route('console.menu.update', $menu->id) }}"
                    ...
                    <div class="row">
                        <div class="col-12">
                                    ...
                                    <select
                                        ...
                                        @foreach ($menuCategories as $menuCategory)
                                            <option value="{{ $menuCategory->id }}"
                                                {{ old('menu_category_id', $menu->menu_category_id) == $menuCategory->id ? 'selected' : null }}>
                                                {{ $menuCategory->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Nama"
                                        ...
                                        name="name" value="{{ old('name', $menu->name) }}" required="required">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea class="form-control form-control-line @error('description') is-invalid @enderror" name="description"
                                        rows="3" placeholder="Deskripsi">{{ old('description', $menu->description) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Rp0"
                                        ...
                                        name="price" required="required" value="{{ old('price', $menu->price) }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="checkbox" class="toggle-switch" data-toggle="toggle" data-on="Ya"
                                        data-off="Tidak" data-off="Tidak" data-onstyle="success" data-offstyle="danger"
                                        name="is_favorite" value="{{ old('is_favorite', $menu->is_favorite) }}"
                                        {{ old('is_favorite', $menu->is_favorite) == 1 ? 'checked' : null }}>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12 form-control form-control-line">
                                    <div class="input-group bg-white">
                                        ...
                                        <label id="upload-label" for="upload" class="font-weight-light text-muted">Pilih
                                            file</label>
                                        <div class="input-group-append">
                                            <label for="upload" class="btn btn-light m-0 rounded-pill px-4"> <i
                                                    class="fa fa-cloud-upload mr-2 text-muted"></i><small
                                                    class="text-uppercase font-weight-bold text-muted">Pilih
                                                    file</small></label>
                                        </div>
                                    </div>

                                    <div class="image-area mt-2"><img id="imageResult" src="{{ $menu->image_url }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="checkbox" class="toggle-switch" class="toggle-switch"
                                        data-toggle="toggle" data-on="Aktif" data-off="Tidak Aktif"
                                        data-onstyle="success" data-offstyle="danger" name="is_active"
                                        value="{{ old('is_active', $menu->is_active) }}"
                                        {{ old('is_active', $menu->is_active) == 1 ? 'checked' : null }}>
