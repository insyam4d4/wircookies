            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle">Valueable Information</h6>
                        <div class="mt-5 pb-3 d-flex align-items-center">
                            <span class="btn btn-primary btn-circle d-flex align-items-center">
                                <i class="mdi mdi-barcode fs-4"></i>
                            </span>
                            <div class="ms-3">
                                <h5 class="mb-0 fw-bold">New SKU's</h5>
                                <span class="text-muted fs-6">{{ $dailyStats['sku'] }}</span>
                            </div>
                            <div class="ms-auto">
                        ...
                        <div class="py-3 d-flex align-items-center">
                            <span class="btn btn-warning btn-circle d-flex align-items-center">
                                <i class="mdi mdi-cellphone-link fs-4"></i>
                            </span>
                            <div class="ms-3">
                                <h5 class="mb-0 fw-bold">New Products</h5>
                                <span class="text-muted fs-6">{{ $dailyStats['product'] }}</span>
                            </div>
                            <div class="ms-auto">
                                <span class="badge bg-light text-muted">+68%</span>
                            </div>
                        ...
                        <div class="py-3 d-flex align-items-center">
                            <span class="btn btn-success btn-circle d-flex align-items-center">
                                <i class="mdi mdi-qrcode-scan text-white fs-4"></i>
                            </span>
                            <div class="ms-3">
                                <h5 class="mb-0 fw-bold">Seller Scan</h5>
                                <span class="text-muted fs-6">{{ $dailyStats['seller-scan'] }}</span>
                            </div>
                            <div class="ms-auto">
                                <span class="badge bg-light text-muted">+68%</span>
                            </div>
                        ...
                        <div class="py-3 d-flex align-items-center">
                            <span class="btn btn-info btn-circle d-flex align-items-center">
                                <i class="mdi mdi-qrcode-scan fs-4 text-white"></i>
                            </span>
                            <div class="ms-3">
                                <h5 class="mb-0 fw-bold">Buyer Scan</h5>
                                <span class="text-muted fs-6">{{ $dailyStats['sku'] }}</span>
                            </div>
                            <div class="ms-auto">
                ...
                <div class="card">
                    ...
                    <div class="comment-widgets scrollable">
                        ...
                        <div class="d-flex flex-row comment-row m-t-0">
                            <div class="p-2"><img
                                    src="{{ asset('templates/flexy/assets/images/users/1.jpg') }}" alt="user" width="50"
                        ...
                        <div class="d-flex flex-row comment-row">
                            <div class="p-2"><img
                                    src="{{ asset('templates/flexy/assets/images/users/4.jpg') }}" alt="user" width="50"
                                    class="rounded-circle"></div>
                        ...
                        <div class="d-flex flex-row comment-row">
                            <div class="p-2"><img
                                    src="{{ asset('templates/flexy/assets/images/users/5.jpg') }}" alt="user" width="50"
                                    class="rounded-circle"></div>
                            <div class="comment-text w-100">
